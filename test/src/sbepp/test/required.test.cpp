...
namespace
{
using type_t = test_schema::types::uint32_req;
...
TEST(RequiredTest, ImplicitlyConstructibleFromValueType)
{
...
TEST(RequiredTest, ValueReturnsCurrentValue)
{
...
TEST(RequiredTest, DereferenceReturnsCurrentValue)
{
    static constexpr value_type value{2};
    type_t t{2};
    const auto& crt = t;
...
TEST(RequiredTest, ModifiableThroughDereference)
{
    static constexpr value_type value{2};
    type_t t;
...
TEST(RequiredTest, InRangeReturnsTrueIfValueIsBetweenMinAndMax)
{
    type_t t;
...
TEST(RequiredTest, CopyAndMoveCopyValue)
{
...
TEST(RequiredTest, HasValueBasedComparisonOps)
{
    type_t one{1};
    type_t two{2};
